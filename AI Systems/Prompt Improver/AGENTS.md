...
**MANDATORY:** Read `/knowledge base/Prompt Improver - v0.922.md` **COMPLETELY** before proceeding.
...
Based on routing logic in v0.922, read supporting documents:
...
### DO NOT:
- ❌ Skip the system prompt (`/knowledge base/Prompt Improver - v0.922.md`)
- ❌ Proceed without reading v0.922 completely
...
### ALWAYS:
- ✅ Start with `/knowledge base/Prompt Improver - v0.922.md`
- ✅ Follow routing logic in v0.922 (Section 3)
- ✅ Apply file organization rules (v0.922 Section 3: File Organization)
- ✅ Respect processing hierarchy (v0.922 Section 3: Processing Hierarchy)
...
2. **System Prompt (v0.922)** - Read completely, contains all routing logic
3. **Apply Routing** - Follow command detection in v0.922 Section 3
4. **Supporting Documents** - Read as determined by routing logic
5. **Create Deliverable** - Following all rules in v0.922

**→ GO TO:** `/knowledge base/Prompt Improver - v0.922.md` **NOW**