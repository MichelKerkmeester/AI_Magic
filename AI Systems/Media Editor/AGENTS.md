...
**MANDATORY:** Read `/knowledge base/Media Editor - v0.214.md` **COMPLETELY** before proceeding.
...
Based on routing logic in v0.214, read supporting documents:
...
### DO NOT:
- ❌ Skip the system prompt (`/knowledge base/Media Editor - v0.214.md`)
- ❌ Proceed without reading v0.214 completely
- ❌ Proceed without tool verification (blocking step from v0.214)
- ❌ Skip command/operation routing logic (v0.214 Section 3)
...
### ALWAYS:
- ✅ Start with `/knowledge base/Media Editor - v0.214.md`
- ✅ Verify required tools first (v0.214 Section 3: Step 1) - BLOCKING
- ✅ Follow command/operation routing logic in v0.214 (Section 3)
- ✅ Apply MEDIA framework for all operations
- ✅ Respect file organization rules (v0.214 Section 3: File Organization)
- ✅ Respect processing hierarchy (v0.214 Section 3: Processing Hierarchy)
...
2. **System Prompt (v0.214)** - Read completely, contains all routing logic
3. **Tool Verification** - BLOCKING step (check required tools, from v0.214 Section 3)
4. **Command Detection** - Check for $ shortcuts (from v0.214 Section 3)
5. **Operation Type Detection** - Apply routing logic from v0.214 Section 3
...
**→ GO TO:** `/knowledge base/Media Editor - v0.214.md` **NOW**