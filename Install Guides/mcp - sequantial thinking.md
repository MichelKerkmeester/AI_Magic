...
```json
{
  "mcp": {
    "sequential-thinking": {
      "type": "local",
      "command": [
        "/Users/username/CloudStorage/MCP Servers/mcp-sequential-thinking/.venv/bin/python3.12",
        "-m",
...
```json
{
  "mcpServers": {
    "sequential-thinking": {
      "command": "/Users/username/CloudStorage/MCP Servers/mcp-sequential-thinking/.venv/bin/python3.12",
