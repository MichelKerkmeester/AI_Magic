...
```json
{
  "mcpServers": {
    "semantic-search": {
      "command": "/Users/username/CloudStorage/MCP Servers/semantic-search/venv/bin/python",
      "args": ["/Users/username/CloudStorage/MCP Servers/semantic-search/src/server_sqlite.py"],
      "env": {
        "MCP_CODEBASE_EMBEDDER_PROVIDER": "openai-compatible",
...
**Replace** `/Users/username/CloudStorage/` with your actual path.
...
```json
{
  "mcp": {
    "semantic-search": {
      "type": "local",
      "command": [
        "/Users/username/CloudStorage/MCP Servers/semantic-search/venv/bin/python",
        "/Users/username/CloudStorage/MCP Servers/semantic-search/src/server_sqlite.py"
      ],
      "env": {
        "MCP_CODEBASE_EMBEDDER_PROVIDER": "openai-compatible",
        "MCP_CODEBASE_EMBEDDER_API_KEY": "your-key",
...
- **mcp-semantic-search skill**: `.claude/skills/mcp-semantic-search/SKILL.md`
- **Architecture reference**: `.claude/skills/mcp-semantic-search/references/architecture.md`
