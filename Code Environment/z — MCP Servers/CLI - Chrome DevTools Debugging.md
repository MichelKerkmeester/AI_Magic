...
URLS=("https://example.com/en" "https://example.com/nl")
...
0 * * * * /usr/local/bin/bdg https://example.com && /usr/local/bin/bdg console logs | jq '.[] | select(.level=="error")' >> /var/log/console-errors.log && /usr/local/bin/bdg stop
```
