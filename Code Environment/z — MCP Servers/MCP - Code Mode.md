...
# Figma Configuration
# FIGMA_PERSONAL_ACCESS_TOKEN=your-api-key-here

# Notion Configuration
# NOTION_TOKEN=your-api-key-here

# GitHub Configuration
# GITHUB_TOKEN=your-api-key-here
EOF
```
...
For more information, refer to the MCP Protocol documentation and the skill documentation in `.claude/skills/mcp-code-mode/`.
