...
"Unique tools like google_web_search and codebase_investigator provide capabilities unavailable in other AI assistants."

---

## 1. 🌟 UNIQUE TOOLS

Tools available only through Gemini CLI (not in Claude Code).
...
Tool capability comparison between Gemini CLI and Claude Code.
