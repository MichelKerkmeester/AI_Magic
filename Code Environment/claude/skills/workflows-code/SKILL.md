...
**This file (SKILL.md)**: Orchestrator overview, phase detection, rules, and success criteria.

**Reference Files** (detailed workflows):
- [implementation_workflows.md](./references/implementation_workflows.md) – Async waiting, validation, CDN versioning
- [debugging_workflows.md](./references/debugging_workflows.md) – Systematic debugging, root cause tracing
- [verification_workflows.md](./references/verification_workflows.md) – Browser testing requirements (The Iron Law)
- [animation_workflows.md](./references/animation_workflows.md) – CSS vs Motion.dev decision tree
- [webflow_patterns.md](./references/webflow_patterns.md) – Platform limits, collection list patterns
- [performance_patterns.md](./references/performance_patterns.md) – Animation, video, asset optimization
- [security_patterns.md](./references/security_patterns.md) – OWASP Top 10 patterns
- [devtools_guide.md](./references/devtools_guide.md) – Chrome DevTools reference
- [code_quality_standards.md](./references/code_quality_standards.md) – Naming, initialization, file structure
- [shared_patterns.md](./references/shared_patterns.md) – Cross-phase patterns
- [quick_reference.md](./references/quick_reference.md) – One-page cheat sheet

**Assets** (templates):
- [wait_patterns.js](./assets/wait_patterns.js) – Async waiting code templates
- [validation_patterns.js](./assets/validation_patterns.js) – Validation code templates
- [debugging_checklist.md](./assets/debugging_checklist.md) – Step-by-step debugging workflow
...
- **See**: .claude/skills/workflows-chrome-devtools/SKILL.md (complete CLI skill reference)
