...
**This file (SKILL.md)**: Core workflows, routing logic, and essential patterns for browser debugging.

**Reference Files** (detailed documentation):
- [cdp_patterns.md](./references/cdp_patterns.md) – Complete CDP domain patterns, Unix composability, advanced workflows
- [session_management.md](./references/session_management.md) – Session lifecycle, multi-session, error recovery
- [troubleshooting.md](./references/troubleshooting.md) – Installation issues, browser errors, platform-specific fixes

**Examples** (production automation):
- [examples/README.md](./examples/README.md) – Comprehensive usage guide and CI/CD patterns
- [performance-baseline.sh](./examples/performance-baseline.sh) – Performance testing workflow
- [animation-testing.sh](./examples/animation-testing.sh) – Animation validation with thresholds
- [multi-viewport-test.sh](./examples/multi-viewport-test.sh) – Responsive testing across 5 viewports

### Browser Debugging Tasks
