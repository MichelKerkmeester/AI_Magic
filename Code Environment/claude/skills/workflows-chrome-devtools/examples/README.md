...
**Usage:**
```bash
# Default URL (https://example-project.com)
...
- See: `.claude/skills/workflows-code/references/debugging_workflows.md` (Section 7)
- See: `.claude/skills/workflows-code/references/performance_patterns.md` (Section 3)
...
./animation-testing.sh https://example-project.com ".hero" "animate-in"
...
**Workflow integration:**
- See: `.claude/skills/workflows-code/references/animation_workflows.md` (Section 6)
...
./multi-viewport-test.sh https://example-project.com ".hero" "animate-in"
...
**Workflow integration:**
- See: `.claude/skills/workflows-code/references/verification_workflows.md` (Section 2)
- See: `.claude/skills/workflows-code/references/animation_workflows.md` (Multi-Viewport Testing)
...
**CLI Chrome DevTools**:
- `.claude/skills/workflows-chrome-devtools/SKILL.md` - Main skill documentation
- `.claude/skills/workflows-chrome-devtools/references/` - Additional reference materials
...
- **create-documentation** - Documentation creation and validation
