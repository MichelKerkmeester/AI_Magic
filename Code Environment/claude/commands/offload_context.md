...
- **Full Skill:** `.claude/skills/mcp-mnemo/SKILL.md`
- **Semantic Search:** `.claude/skills/mcp-semantic-search/SKILL.md`
- **Semantic Memory:** `.claude/skills/workflows-memory/SKILL.md`