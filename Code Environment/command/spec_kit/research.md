...
│   └─ SET STATUS: ✅ PASSED
│
└─ IF NO mode suffix detected (plain /spec_kit:research):
    │
    ├─ ASK user:
    │   ┌────────────────────────────────────────────────────────────┐
    │   │ "How would you like to execute this research workflow?"    │
    │   │                                                            │
    │   │ A) Autonomous - Execute all 9 steps without approval       │
    │   │    gates. Best for focused research topics.                │
    │   │                                                            │
    │   │ B) Interactive - Pause at each step for approval. Best     │
    │   │    for exploratory research needing direction.             │
    │   └────────────────────────────────────────────────────────────┘
    │
...
- memory/[DD-MM-YY_HH-MM]__research_session.md (context saved)
