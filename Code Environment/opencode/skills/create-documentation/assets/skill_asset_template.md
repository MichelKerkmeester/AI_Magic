...
Templates and guidelines for creating asset files in Claude skills. Asset files contain reference data, templates, examples, and lookup tables that support skill functionality.
...
**Location**: `.claude/skills/[skill-name]/assets/`
...
## 13. 📚 ASSET FILE NAMING QUICK REFERENCE
...
**Related Files**:
- See `frontmatter_templates.md` for YAML frontmatter examples
- See `llmstxt_templates.md` for llms.txt file templates
- See `../references/skill_creation.md` for full skill creation workflow