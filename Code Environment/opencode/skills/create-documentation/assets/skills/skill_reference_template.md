# Skill Reference File Templates - Claude Skills

Comprehensive templates for creating effective reference files for Claude skills. Reference files provide deep-dive technical guidance with explicit reasoning - step-by-step workflows, decision logic, validation checkpoints, and root cause analysis.

---

## 1. 📖 INTRODUCTION & PURPOSE

### What Are Claude Skill Reference Files?
...
- Claude skills = Actionable workflows with explicit reasoning
...
**Reference files = Level 3**: Deep technical guidance loaded only when Claude needs specific workflow details.
...
### Reference File Types for Claude Skills
...
## 3. 🧠 CLAUDE SKILL REFERENCE CHARACTERISTICS
...
**Related Files**:
- See [skill_md_template.md](./skill_md_template.md) for SKILL.md file templates
- See [skill_asset_template.md](./skill_asset_template.md) for asset file templates
...
- See `../references/core_standards.md` for structural requirements