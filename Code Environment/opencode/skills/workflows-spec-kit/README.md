...
Five SpecKit commands available in both Claude Code and OpenCode.
...
| **Commands**                | ✅ Identical (5)          | ✅ Identical (5)          |
...
| `workflows-memory-trigger.sh` | Auto-saves every 20 messages   |
...
A: Yes, identical 5 commands exist in both platforms with the same behavior.
