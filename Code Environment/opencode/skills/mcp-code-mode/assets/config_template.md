...
- [naming_convention.md](../references/naming_convention.md) - Tool naming patterns (CRITICAL)
- [configuration.md](../references/configuration.md) - Detailed configuration guide
- [tool_catalog.md](../references/tool_catalog.md) - Complete list of available tools
