...
> Configuration for memory trigger phrases and auto-save intervals.

---

## 1. 📖 OVERVIEW

The memory workflow can be triggered through explicit phrases or automated intervals. This reference details the configuration options for both trigger detection and auto-save behavior.

---

## 2. 🎯 TRIGGER PHRASES

The following phrases activate memory (case-insensitive):
