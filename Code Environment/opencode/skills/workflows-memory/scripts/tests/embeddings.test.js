...
async function runTests() {
  ...
  assert(embeddings.EMBEDDING_DIM === 768, 'EMBEDDING_DIM is 768');
  assert(embeddings.MAX_TEXT_LENGTH === 8000, 'MAX_TEXT_LENGTH is 8000');
  assert(embeddings.MODEL_NAME === 'nomic-ai/nomic-embed-text-v1.5', 'MODEL_NAME is correct');
  ...
  assert(embedding.length === 768, 'Embedding has 768 dimensions');
  ...
  assert(longEmbedding.length === 768, 'Long text embedding has correct dimensions');
  ...
  assert(japaneseEmb.length === 768, 'Japanese text has correct dimensions');
  ...
  assert(chineseEmb.length === 768, 'Chinese text has correct dimensions');
  ...
  assert(koreanEmb.length === 768, 'Korean text has correct dimensions');
  ...
  assert(arabicEmb.length === 768, 'Arabic text has correct dimensions');
  ...
  assert(mixedEmb.length === 768, 'Mixed script has correct dimensions');
  ...
  assert(emojiEmb.length === 768, 'Emoji text has correct dimensions');
  ...
  assert(diacriticEmb.length === 768, 'Diacritic text has correct dimensions');
  ...
  assert(codeEmb.length === 768, 'Code text has correct dimensions');
