...
allowed-tools: Bash, Read, Write, AskUserQuestion, mcp__semantic_memory__memory_search, mcp__semantic_memory__memory_load
---
...
3. ASK user with these EXACT options:
   ...
   │ C) Create new spec folder: specs/[NNN]-[query-slug]/       │
