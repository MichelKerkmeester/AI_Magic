...
2. Skill tool invokes `workflows-plan-claude`
...
1. **Invoke Skill**:
   ```
   Skill tool: skill="workflows-plan-claude"
   ```
...
1. **Load Template**: Read `.opencode/speckit/templates/plan_template.md`
...
step_6_planning:
  skill_invocation:
    ...
    tool: Skill
    parameter: skill="workflows-plan-claude"
    inputs:
...
**Invocation**: `Skill(skill: "workflows-plan-claude")`
