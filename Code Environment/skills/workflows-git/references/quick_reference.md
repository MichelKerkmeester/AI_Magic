...
**Detailed Workflows**:
- [worktree_workflows.md](./worktree_workflows.md) - Complete git-worktrees workflow
- [commit_workflows.md](./commit_workflows.md) - Complete git-commit workflow
- [finish_workflows.md](./finish_workflows.md) - Complete git-finish workflow
- [shared_patterns.md](./shared_patterns.md) - Common patterns and commands
