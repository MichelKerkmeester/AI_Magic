...
|--------------|---------|-------------|--------------|
| `tasks_template.md` | `tasks.md` | After plan.md, before coding - breaks plan into actionable tasks | `cp .opencode/speckit/templates/tasks_template.md specs/###-name/tasks.md` |
| `checklist_template.md` | `checklist.md` | When systematic validation needed (QA, security, deployment) | `cp .opencode/speckit/templates/checklist_template.md specs/###-name/checklist.md` |
| `decision_record_template.md` | `decision-record-[topic].md` | Major technical decisions (database choice, architecture) | `cp .opencode/speckit/templates/decision_record_template.md specs/###-name/decision-record-database.md` |
| `research_spike_template.md` | `research-spike-[topic].md` | Before uncertain work - research, POC, feasibility | `cp .opencode/speckit/templates/research_spike_template.md specs/###-name/research-spike-performance.md` |
...
**Level 1:**
```bash
cp .opencode/speckit/templates/spec_template.md specs/###-name/spec.md
```

**Level 2:**
```bash
cp .opencode/speckit/templates/spec_template.md specs/###-name/spec.md
cp .opencode/speckit/templates/plan_template.md specs/###-name/plan.md
```
...
cp .opencode/speckit/templates/tasks_template.md specs/###-name/tasks.md

# Checklist (validation needs)
cp .opencode/speckit/templates/checklist_template.md specs/###-name/checklist.md

# Decision Record (use descriptive name)
cp .opencode/speckit/templates/decision_record_template.md specs/###-name/decision-record-database.md

# Research-Spike (use descriptive name)
cp .opencode/speckit/templates/research_spike_template.md specs/###-name/research-spike-performance.md
```
