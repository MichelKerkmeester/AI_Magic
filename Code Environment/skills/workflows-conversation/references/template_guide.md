...
**Copy command:**
```bash
cp .opencode/speckit/templates/research_template.md specs/###-name/research.md
```
...
**Copy command:**
```bash
cp .opencode/speckit/templates/research_spike_template.md specs/###-name/research-spike-[topic].md
```
...
**Copy command:**
```bash
cp .opencode/speckit/templates/decision_record_template.md specs/###-name/decision-record-[topic].md
```
...
**Right:**
```bash
cp .opencode/speckit/templates/spec_template.md specs/042-feature/spec.md
```
...
### 9.1 Automatic Sub-Folder Versioning (Hook-Triggered)

**Triggered when:** User selects Option A to reuse existing spec folder with root-level content.

**How it works:**
1. Hook detects existing spec.md/plan.md at root level
...
5. Updates `.spec-active` marker to track active sub-folder
...
**See:** `workflows-conversation SKILL.md` Section 3.4 for full versioning workflow.
...
```bash
cp .opencode/speckit/templates/subfolder_readme_template.md \
