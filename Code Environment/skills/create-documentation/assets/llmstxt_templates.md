...
> An AI agent skill that optimizes project documentation and README files to score highly
...
- [Optimization Guide](https://github.com/example/c7score-optimizer/blob/main/references/optimization.md): C7score metrics and transformation patterns
- [Validation Guide](https://github.com/example/c7score-optimizer/blob/main/references/validation.md): Quality scoring and gates
- [Core Standards](https://github.com/example/c7score-optimizer/blob/main/references/core_standards.md): Document types and structural rules
