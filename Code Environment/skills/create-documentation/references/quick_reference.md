...
**Issue**: Validation not running as expected
**Fix**: Apply validation checks manually (see workflows.md Section 3)
...
```
.opencode/skills/markdown-c7-optimizer/
...
**Validation Patterns**:
> **Note:** Run these validations manually after file operations.
- **Post-Write Validation** - Filename fixes (after file operations)
- **Pre-Submit Validation** - Structure validation (before processing)
