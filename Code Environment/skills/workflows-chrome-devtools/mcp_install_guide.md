...
3. In your AI client, ask: "Take a screenshot of example.com"
...
> - [cdp_patterns.md](./references/cdp_patterns.md) - CDP domain patterns and Unix composability
> - [troubleshooting.md](./references/troubleshooting.md) - Detailed error resolution
> - [examples/README.md](./examples/README.md) - Production automation templates
...
| CDP Patterns    | `./references/cdp_patterns.md`    | Domain patterns      |
| Troubleshooting | `./references/troubleshooting.md` | Detailed fixes       |
| Examples        | `./examples/README.md`            | Production templates |
