...
### Pairs With
- **implementation_workflows** - Apply patterns during implementation
- **debugging_workflows** - Use DevTools and logging during debugging
- **verification_workflows** - Use browser testing patterns for verification
