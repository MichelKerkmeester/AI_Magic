...
- [1. Before Attempting Any Fix](#1-️-before-attempting-any-fix)
- [2. Phase 1: Root Cause Investigation](#2-️-phase-1-root-cause-investigation)
- [3. Phase 2: Pattern Analysis](#3-️-phase-2-pattern-analysis)
- [4. Phase 3: Hypothesis and Testing](#4-️-phase-3-hypothesis-and-testing)
- [5. Phase 4: Implementation](#5-️-phase-4-implementation)
- [6. Root Cause Tracing Checklist](#6-️-root-cause-tracing-checklist)
- [7. Final Verification](#7-️-final-verification)
- [8. If Still Stuck](#8-️-if-still-stuck)
...
**See also:**
- [../references/debugging_workflows.md](../references/debugging_workflows.md) - Full debugging guide
- [../references/devtools_guide.md](../references/devtools_guide.md) - DevTools reference
