...
- [1. Before Claiming Anything](#1-️-before-claiming-anything)
- [2. Browser Testing](#2-️-browser-testing)
- [3. Viewport Testing](#3-️-viewport-testing)
- [4. Functionality Testing](#4-️-functionality-testing)
- [5. Console & Errors](#5-️-console--errors)
- [6. Documentation](#6-️-documentation)
- [7. Red Flags Avoided](#7-️-red-flags-avoided)
- [8. Final Verification](#8-️-final-verification)
- [9. Claiming Format](#9-️-claiming-format)
- [10. Special Cases](#10-️-special-cases)
...
**See also:**
- [../references/verification_workflows.md](../references/verification_workflows.md) - Full verification guide
- [../references/quick_reference.md](../references/quick_reference.md) - Quick checklist
