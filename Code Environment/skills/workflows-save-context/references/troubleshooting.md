...
> Common issues and solutions for save-context.

---

## 1. 📖 OVERVIEW

This reference provides solutions for common save-context issues, including alignment scoring problems, context retrieval failures, and script execution errors.
...
| Wrong script path | Use `.opencode/skills/workflows-save-context/scripts/generate-context.js` |
