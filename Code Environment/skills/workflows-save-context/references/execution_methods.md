...
> Four independent execution paths for save-context, plus anchor-based retrieval.
...
**Location**: `.opencode/skills/workflows-save-context/scripts/save-context-manual.sh`

**Usage**:
```bash
# Save to specific spec folder
bash .opencode/skills/workflows-save-context/scripts/save-context-manual.sh \
  "049-anchor-context-retrieval" \
  "Manual save session"
...
# Show help
bash .opencode/skills/workflows-save-context/scripts/save-context-manual.sh --help
```
